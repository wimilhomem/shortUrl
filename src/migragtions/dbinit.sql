...
(
    ...
    "originalUrl" character varying COLLATE pg_catalog."default" NOT NULL,
    "shortUrl" character varying COLLATE pg_catalog."default" NOT NULL,
    "exptDate" timestamp with time zone NOT NULL,
